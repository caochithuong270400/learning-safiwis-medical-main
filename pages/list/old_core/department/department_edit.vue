  ...
  <v-form id="edit-form" ref="form" v-model="valid" lazy-validation>
    <v-toolbar flat>
      ...
      <v-toolbar-title v-if="isEdit" class="blue--text font-weight-bold">{{
        `Chỉnh sửa phòng ban: ${title_name}`
      }}</v-toolbar-title>
      <v-toolbar-title v-if="!isEdit" class="blue--text font-weight-bold">{{
        `Thêm phòng ban `
      }}</v-toolbar-title>
    ...
    <v-card elevation="2" class="mx-auto" outlined>
      <v-row class="pa-5">
        ...
        <v-col cols="12" sm="6" lg="6" xl="6" md="6">
          <v-autocomplete
            v-model="department.internal_hospital"
            label="Bệnh viện"
            :items="hospitals"
            item-text="name"
            item-value="id"
        ...
        <v-col cols="12" sm="6" lg="6" xl="6" md="6">
          <v-checkbox
            v-model="department.in_service"
            :label="`Có thực hiện dịch vụ`"
          ></v-checkbox>
        </v-col>

        <v-col cols="12" sm="6" lg="6" xl="6" md="6">
          <v-checkbox
            v-model="department.hrm"
